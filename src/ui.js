...
function renderDashboard({
  ...
  `
    ...
    <section>
      ...
      <p class="muted">Сервіс сам запустить CSV CONTROL IMPORT аудит після старту.</p>
    </section>
  `;
...
<title>PrimeTac Sync v1.8.0</title>
<style>
...
<header>
<div>
<h1>PrimeTac Sync v1.8.0</h1>
<span class="badge">CSV CONTROL IMPORT</span>
<div class="config">

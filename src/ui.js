...
function renderDashboard({
  ...
  `
    ...
    <section>
      ...
      <p class="muted">Сервіс сам запустить PLACEMENT AUDIT аудит після старту.</p>
    </section>
  `;
...
<title>PrimeTac Sync v1.8.3</title>
<style>
...
<header>
<div>
<h1>PrimeTac Sync v1.8.3</h1>
<span class="badge">PLACEMENT AUDIT</span>
<div class="config">
